...
class HomePage extends StatelessWidget {
                ...
                return Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: (){},
                        child: SvgPicture.asset('assets/icons/button-right.svg',
                        width: 30,
                        height: 30,
                        ),
                      ),
                        ...
                        Container(
                          ...
                          child: Center(
                            child: Text(
                              ...
                              style: TextStyle(
                                color:
                                diets[index].viewIsSelected ? Colors.white : const Color(0xffC58BF2),
                                fontWeight: FontWeight.w600,
                                fontSize: 14,
                              ),),
                          ),
              ...
              suffixIcon: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: SvgPicture.asset('assets/icons/filter-circle.svg'),
                    ),
                  ],
                ),
              ),
  ...
  AppBar appBar() {
    return AppBar(
      title: const Text('3an Breakfast',
      style: TextStyle(
        color: Colors.black,
        fontSize: 18,
